...
<body>
		...
		<div class="container">
			...
			<div class="col-md-4 col-12 text-right">
				<p class="my-md-4 header-links">
					<a href="./adminlogout.jsp" class="px-2">Logout</a>
				</p>
			</div>
		</div>
		</div>
	...
	<!--header-->
	<main>
		1)<b><a href="log.jsp">Click Here</a></b> To View The Log of Users.<br/>
		2)<b><a href="sales.jsp">Click Here</a></b> To View the Sales.
