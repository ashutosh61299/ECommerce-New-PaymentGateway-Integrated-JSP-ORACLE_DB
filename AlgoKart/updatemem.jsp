	...
	<header>
		<div class="container">
			...
			<div class="col-md-4 col-12 text-center">
				<a href="./index.jsp"><h2 class="my-md-3 site-title text-white" >AlgoKart</h2></a>
			</div>
		...
		<div class="container-fluid p-0">
		  ...
		  <div class="collapse navbar-collapse" id="navbarNav">
		    <ul class="navbar-nav">
		     ...
		     <li class="nav-item active">
		        <a class="nav-link" href="#">NOKIA <span class="sr-only">(current)</span></a>
		      </li>
		      <li class="nav-item active">
		        <a class="nav-link" href="#">SONY <span class="sr-only">(current)</span></a>
		      </li>
		     <li class="nav-item active">
		        <a class="nav-link" href="#">HTC <span class="sr-only">(current)</span></a>
		      </li>
		      <li class="nav-item active">
		        <a class="nav-link" href="#">LG <span class="sr-only">(current)</span></a>
		      </li>
		    </ul>
		  </div>
	...
	<main>
       ...
       Class.forName("oracle.jdbc.driver.OracleDriver");
        conn=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","ashutosh","ashu");
		 ...
		 String sql = "UPDATE register1 set address=?, phone=?, email=? where id=?"; 
		 ps = conn.prepareStatement (sql);
		 ps.setString(4,request.getParameter("mid1"));
